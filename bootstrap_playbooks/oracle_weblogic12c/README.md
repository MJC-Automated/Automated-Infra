...
additional_weblogic_domains:
  - domain_name: MUTUAL_domain2
    domain_home: "{{ oracle_middleware_home }}/user_projects/domains/MUTUAL_domain2"
    admin_port: 8106
    managed_servers:
      - name: ms2
        listen_port: 8101
...
ssh ansible@<weblogic12c-host> "sudo systemctl status wlsMUTUALDOMAIN8006.service wlsMUTUALDOMAIN8001.service wlsMUTUALDOMAIN28106.service wlsMUTUALDOMAIN28101.service"
