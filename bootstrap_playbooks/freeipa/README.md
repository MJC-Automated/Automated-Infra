...
- Host A/AAAA for the FreeIPA server FQDN, for example `public-freeipa-02.example.internal -> 198.51.100.91`
- Host A/AAAA for `ipa-ca.<domain>`, for example `ipa-ca.example.internal -> 198.51.100.91`
- SRV records:
...
host-record=public-freeipa-02.example.internal,198.51.100.91
host-record=ipa-ca.example.internal,198.51.100.91
...
```bash
dig @198.51.100.92 +short A ipa-ca.example.internal
dig @198.51.100.92 +short SRV _ldap._tcp.example.internal
dig @198.51.100.92 +short TYPE256 _kerberos.example.internal
```
