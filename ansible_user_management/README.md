...
```bash
# Skip defaults (Optional)
ansible-playbook -i ../inventories/<en>/inventory.ini -i ../inventories/aliases.ini main.yml  --ask-vault-pass

# Create or update users
ansible-playbook main.yml

# Or explicitly point at the Terraform-generated inventory
ansible-playbook -i ../inventories/dev/inventory.ini main.yml
...
1. **Add a user**
   ...
   - Re-run:
     ```bash
     ansible-playbook --ask-vault-pass main.yml --limit <group>
     ```
