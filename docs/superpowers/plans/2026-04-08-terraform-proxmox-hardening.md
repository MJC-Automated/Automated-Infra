...
run "valid_unique_vmids" {
  ...
  variables {
    node_groups = {
      "group1" = {
        "vm1" = {
          vmid = 100, name = "test-vm1", ipconfig0 = "ip=198.51.100.0/24,gw=198.51.100.32"
          cores = 2, memory = 2048, disk_size = "20G"
        }
      }
      "group2" = {
        "vm2" = {
          vmid = 200, name = "test-vm2", ipconfig0 = "ip=203.0.113.0/24,gw=198.51.100.32"
          cores = 2, memory = 2048, disk_size = "20G"
        }
      }
    }
...
run "duplicate_vmids_rejected" {
  ...
  variables {
    node_groups = {
      ...
      "group2" = {
        "vm2" = {
          vmid = 100, name = "test-vm2", ipconfig0 = "ip=203.0.113.0/24,gw=198.51.100.32"
          cores = 2, memory = 2048, disk_size = "20G"
        }
      }
    }
...
run "vmid_below_100_rejected" {
  ...
  variables {
    node_groups = {
      "group1" = {
        "vm1" = {
          vmid = 99, name = "test-vm1", ipconfig0 = "ip=198.51.100.0/24,gw=198.51.100.32"
          cores = 2, memory = 2048, disk_size = "20G"
        }
      }
    }
...
run "vmid_in_template_range_rejected" {
  ...
  variables {
    node_groups = {
      "group1" = {
        "vm1" = {
          vmid = 999999990, name = "test-vm1", ipconfig0 = "ip=198.51.100.0/24,gw=198.51.100.32"
          cores = 2, memory = 2048, disk_size = "20G"
        }
      }
    }
...
run "explicit_os_profile_override" {
  ...
  variables {
    node_groups = {
      "mygroup" = {
        "vm1" = {
          vmid = 100, name = "test-vm", ipconfig0 = "ip=198.51.100.0/24,gw=198.51.100.32"
          cores = 2, memory = 2048, disk_size = "20G"
          os_profile = "oracle9"
        }
      }
...
run "group_os_profile_map_lookup" {
  ...
  variables {
    node_groups = {
      "database19c" = {
        "vm1" = {
          vmid = 100, name = "test-db", ipconfig0 = "ip=198.51.100.0/24,gw=198.51.100.32"
          cores = 2, memory = 2048, disk_size = "20G"
        }
      }
    }
...
run "regex_inference_weblogic14" {
  ...
  variables {
    node_groups = {
      "weblogic14" = {
        "vm1" = {
          vmid = 100, name = "test-wl", ipconfig0 = "ip=198.51.100.0/24,gw=198.51.100.32"
          cores = 2, memory = 2048, disk_size = "20G"
        }
      }
    }
...
run "unknown_group_uses_default" {
  ...
  variables {
    node_groups = {
      "customapp" = {
        "vm1" = {
          vmid = 100, name = "test-custom", ipconfig0 = "ip=198.51.100.0/24,gw=198.51.100.32"
          cores = 2, memory = 2048, disk_size = "20G"
        }
      }
    }
